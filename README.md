...
## Learning Objectives
- Understand how to replicate a good BMI calculator application which is used to calculate body mass index of an individual in order to ascertain an individual's weight condition, and it supports excellent user experience, and has beautiful user interface.

## Description of the Project
For the first milestone in the process of creating bmi calculator application, you will:
